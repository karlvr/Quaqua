/*
 * @(#)Quaqua14SpinnerUI.java  1.1.1  2005-09-03
 *
 ...
 * @version 1.1 2005-09-03 Fixed visual margin.
 * <br>1.1 2005-07-17 Adapted to changes in interface VisuallyLayoutable.
 * <br>1.0 June 27, 2005 Created.
 */
public class Quaqua14SpinnerUI extends BasicSpinnerUI implements VisuallyLayoutable {
    /**
    ...
    private static class PropertyChangeHandler implements PropertyChangeListener {
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (e.getSource() instanceof JSpinner) {
                ...
                if (spinnerUI instanceof Quaqua14SpinnerUI) {
