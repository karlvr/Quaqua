/*
 * @(#)QuaquaListUI.java  1.4  2008-04-22
 *
 ...
 * @version 1.4 2008-04-22 On mousePressed, requestFocusInWindow.
...
public class QuaquaListUI extends BasicListUI {
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        if (treeSelectionBackground instanceof MutableColorUIResource) {
            ((MutableColorUIResource) treeSelectionBackground).setColor(
                    UIManager.getColor((isFocused && isEnabled) ? "Tree.activeSelectionBackground" : "Tree.inactiveSelectionBackground"));
        }

        if (treeSelectionForeground instanceof MutableColorUIResource) {
            ((MutableColorUIResource) treeSelectionForeground).setColor(
                    UIManager.getColor((isFocused && isEnabled) ? "Tree.activeSelectionForeground" : "Tree.inactiveSelectionForeground"));
        }
