/*
 * @(#)Application.java  2.1.1  2008-03-16
 *
 ...
 * @version 2.1.1 2008-03-16 Improved scaling quality of application icon. 
                    ...
                    try {
                        ...
                        if (value != null && value.equals("true")) {
                            success = true;
                                ...
                                String libraryName = "quaqua";
                            try {
                                String osArch = System.getProperty("os.arch");
                                libraryName = (osArch.equals("ppc64") ||
                                        osArch.equals("i686")) ? "quaqua64" : "quaqua";
