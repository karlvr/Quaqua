...
import ch.randelshofer.quaqua.ext.batik.ext.awt.image.rendered.AffineRed;
...
public class GraphicsUtil {
    ...
    public static void drawImage(Graphics2D g2d,
        ...
        if (g2dCS == null) // Assume device is sRGB
        {
        ...
        try {
            ...
            if ((srcSM.getWidth() * srcSM.getHeight()) >=
                    (clipR.width * clipR.height)) // if srcSM tiles are around the clip size
            ...
            if (useDrawRenderedImage) {
                ...
                wr = ((WritableRaster) r).createWritableChild(clipR.x, clipR.y, clipR.width, clipR.height,
                        0, 0, null);
