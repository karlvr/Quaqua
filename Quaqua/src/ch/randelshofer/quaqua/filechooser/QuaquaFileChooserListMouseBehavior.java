...
public class QuaquaFileChooserListMouseBehavior extends QuaquaListMouseBehavior {
    ...
    public QuaquaFileChooserListMouseBehavior(JFileChooser fc, JList list) {
        super(list);
        this.fc = fc;
    }

    public QuaquaFileChooserListMouseBehavior(JFileChooser fc, GenericList list) {
        super(list);
        this.fc = fc;
    }
    ...
    protected int getSelectionOperation(MouseEvent e) {
        ...
        /*
          The behavior of NSSavePanel is somewhat weird and not worth emulating. The simple model: an unmodified
          click on a traversable directory selects the directory in the browser, on anything else it transfers the
          item name to the text field without changing the browser selection. Modified clicks do nothing.
        */
        ...
        /*
          Command-clicking a traversable directory that is not an acceptable result has no effect unless the
          selection is empty or the item is selected.
        */
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        /*
          If after all operations have been performed there are no selected items in the list, transfer the focus
          to the parent list.
        */
