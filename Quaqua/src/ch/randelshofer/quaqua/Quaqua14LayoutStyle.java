/*
 * @(#)Quaqua14LayoutStyle.java  1.2 2007-12-18
 *
...
import java.util.*;
/**
 * A Quaqua14LayoutStyle can be queried for the preferred gaps between two
 ...
 * to 8. 
 * <br>1.1 2007-04-15 getContainerGap must return a clone of the Insets. 
 * <br>1.0.1 2006-02-02 Fixed a NoSuchMethodException which occured, when
 * a gap for a JComponent was queried, which had no getUI() method. Tweaked
 * INDENT values.
