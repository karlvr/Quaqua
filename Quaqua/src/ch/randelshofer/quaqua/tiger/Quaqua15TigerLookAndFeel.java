...
public class Quaqua15TigerLookAndFeel extends BasicQuaquaLookAndFeel {
    ...
    protected void initDesignDefaults(UIDefaults table) {
        ...
        Object[] uiDefaults = {
            ...
            "Label.shadowForeground", new AlphaColorUIResource(0x2f000000),
            //
            ...
            "Tree.sideBar.background", new ColorUIResource(0xe7edf6),
            "Tree.sideBar.selectionBorder", new UIDefaults.ProxyLazyValue("ch.randelshofer.quaqua.tiger.QuaquaTigerSideBarSelectionBorder"),
            ...
            "Tree.sideBarCategory.font", new FontUIResource("Lucida Grande", Font.PLAIN, 11),
