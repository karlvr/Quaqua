...
public class Quaqua18LookAndFeel extends LookAndFeelProxy15 {
    ...
    protected void initClassDefaults(UIDefaults table) {
        ...
        Object[] uiDefaults = {
            ...
            "ToggleButtonUI", myPrefix + "ToggleButtonUI",
            "SeparatorUI", myPrefix + "SeparatorUI",
            ...
            "SplitPaneUI", myPrefix + "SplitPaneUI",
            ...
            "TreeUI", myPrefix + "TreeUI",
            //"LabelUI", quaquaPrefix + "LabelUI",
            "ListUI", myPrefix + "ListUI",
            "TabbedPaneUI", myPrefix + "TabbedPaneUI",
            //"ToolBarUI", quaquaPrefix + "ToolBarUI",
            //"ToolTipUI", basicPrefix + "ToolTipUI",
            "ComboBoxUI", myPrefix + "ComboBoxUI",
            "TableUI", myPrefix + "TableUI",
            ...
            "PanelUI", myPrefix + "PanelUI",    // supported TitledBorders
...
//    }
    ...
    protected void initFontDefaults(UIDefaults table) {
        ...
        // TBD: Helvetica Neue is not the same as the Yosemite system fonts, but those fonts are not
        // accessible without hacking with native code
...
//             "ToolBar.titleFont", miniSystemFont,
             ...
             "Tree.sideBarCategory.selectionFont", new FontUIResource(name, Font.BOLD, 11),
...
//             "Viewport.font", systemFont,
    ...
    protected void initGeneralDefaults(UIDefaults table) {
        ...
        Object buttonBorder = new UIDefaults.ProxyLazyValue(
                "ch.randelshofer.quaqua.quaqua18.QuaquaDynamicButtonBorder$UIResource"
                );
...
//            "SplitPane.opaque", opaque,
            ...
            "SplitPaneDivider.background", new ColorUIResource(Color.WHITE),
...
//            "Viewport.opaque", Boolean.TRUE,
    ...
    protected void initDesignDefaults(UIDefaults table) {
        ...
        ColorUIResource sideBarIconColor = new ColorUIResource(115, 115, 115);
        ColorUIResource sideBarIconSelectionColor = new ColorUIResource(95, 95, 95);
        ...
        String myImagesDir = "/ch/randelshofer/quaqua/quaqua18/images/";

        UIResource groupBoxPainter = null;

        /*
            Correct flaw in Aqua LAF: group box border is heavier than it should be on Yosemite.
        */

        if (design == QuaquaManager.YOSEMITE) {
            groupBoxPainter = new SlicedImagePainter.UIResource(
                            QuaquaIconFactory.getImage(myImagesDir + "GroupBoxBorder.png"),
                            new NineSliceMetrics(12, 12, 4, 4, 4, 4));
        }

        ColorUIResource listAlternateBackground = new ColorUIResource(245, 245, 245);
        ColorUIResource selectionBackground = new ColorUIResource(30, 107, 214);
        ColorUIResource selectionForeground = new ColorUIResource(255, 255, 255);
        ColorUIResource inactiveSelectionBackground = new ColorUIResource(220, 220, 220);
        ColorUIResource inactiveSelectionForeground = new ColorUIResource(0, 0, 0);
        ...
        Object[] uiDefaults = {
            ...
            //
            "Browser.selectionBackground", selectionBackground,
            "Browser.selectionForeground", selectionForeground,
...
//            "ComboBox.popupBorder", new UIDefaults.ProxyLazyValue("ch.randelshofer.quaqua.leopard.QuaquaLeopardComboBoxPopupBorder"),
            ...
            "FileChooser.browserListUIClass", "ch.randelshofer.quaqua.quaqua18.QuaquaFileChooserBrowserListUI",
            ...
            "FileChooser.sideBarTreeUIClass", "ch.randelshofer.quaqua.quaqua18.QuaquaTreeUI",
            //
...
//            "Label.shadowForeground", new AlphaColorUIResource(0x7e000000),
            ...
            "List.inactiveSelectionForeground", inactiveSelectionForeground,
            "List.alternateBackground.0", listAlternateBackground,
            "List.alternateBackground.1", table.get("List.background"),
...
//            "Separator.border", new VisualMarginBorder(),
            //
            "TabbedPane.slicedImagePainter", groupBoxPainter,
...
//            "Table.scrollPaneBorder", scrollPaneBorder,
            ...
            "Table.inactiveSelectionBackground", inactiveSelectionBackground,
            "Table.inactiveSelectionForeground", inactiveSelectionForeground,
            "Table.alternateBackground.0", listAlternateBackground,
            "Table.alternateBackground.1", table.get("Table.background"),
            "Table.gridColor", new ColorUIResource(205, 205, 205),
...
//            "TextField.searchBorderInsets", new InsetsUIResource(6,12,5,12),
            ...
            //
            "TitledBorder.border", groupBoxPainter,
...
//            "ToolBarSeparator.foreground", new ColorUIResource(0x808080),
            ...
            "Tree.alternateBackground.1", table.get("Tree.background"),
            ...
            "Tree.sideBar.background", new ColorUIResource(220, 220, 220),
            "Tree.sideBar.inactiveBackground", new ColorUIResource(245, 245, 245),
            "Tree.sideBar.selectionBackground", new ColorUIResource(160, 160, 160),
            "Tree.sideBar.inactiveSelectionBackground", new ColorUIResource(205, 205, 205),
            "Tree.sideBar.icons", makeIcons(lionDir + "Tree.sideBar.icons.png", 15, true),
            "Tree.sideBar.foreground", new ColorUIResource(45, 45, 45),
            "Tree.sideBar.selectionForeground", new ColorUIResource(0, 0, 0),
            "Tree.sideBarCategory.foreground", new ColorUIResource(95, 95, 95),
            "Tree.sideBarCategory.selectionForeground", new ColorUIResource(0, 0, 0),
        };
