 ...
 * @version $Id$
 */
public class QuaquaPanelUI extends AquaPanelUI {
    // Shared UI object
    ...
    public void paint(Graphics gr, JComponent c) {
        ...
        // AquaPanelUI has special code in update() to paint textured backgrounds. Unfortunately, update() is final and
        // the code to test for and paint textured backgrounds is private. We do not want to paint over that background
        // unless we need to do something different. Therefore we test for PaintableColor.

        if (c.isOpaque()) {
            Color bc = c.getBackground();
            if (bc instanceof PaintableColor) {
