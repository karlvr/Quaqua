...
/**
 * A customized version of AquaButtonToggleUI. Works around bugs in AquaButtonUI.
 */

public class QuaquaToggleButtonUI extends AquaButtonToggleUI {

    private static QuaquaToggleButtonUI buttonUI = new QuaquaToggleButtonUI();
