/*
 * @(#)OSXTigerFileSystemView.java 1.2  2007-01-24
 *
 ...
 * @version 1.2 2007-01-24 Determine system volume lazily. Create FileView
 * lazily.
...
public class OSXTigerFileSystemView extends QuaquaFileSystemView {
    ...
    public synchronized FileView getFileView() {
        // FIXME - This method needs to be synchronized. If it wouldn't be,
        // we would create multiple file views
        if (fileView == null) {
            ...
            public void updateUI() {
                try {
                    ...
                    try {
                        ...
                        // Fixme We need JDK 1.4 to compile this.
                        //error.initCause(e);
                        throw error;
                    }
                }
